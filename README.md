...
Проверить их наличие можно с помощью команды ls -la ~/.ssh/
...
- введите в Git Bash команду ssh-keygen -t ed25519 -C "электронная почта, к которой привязан ваш аккаунт на GitHub"
(если имеется сообщение об ошибке, то, скорее всего, система не поддерживает алгоритм шифрования ed25519,
альтернативный вариант ssh-keygen -t rsa -b 4096 -C "-//-")
...
- убедитесь в создании ключевой пары через команду ls -a ~/.ssh (если вы сохраняли в папку не по умолчанию,
вместо символа ~ введите путь к папке)
...
- если вы не зарегистрированы, зарегистрируйтесь на сайте https://github.com
...
- проверьте правильность ключа с помощью команды ssh -T git@github.com в приложении Git Bash
...
Сделать это можно с помощью команды git remote -v в приложении Git Bash. 
...
Для загрузки изменений на удаленный репозиторий необходимо ввести команду git push.
